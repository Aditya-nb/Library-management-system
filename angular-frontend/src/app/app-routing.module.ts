...
import { TransactionBookComponent } from './transaction-book/transaction-book.component';
...
const routes: Routes = [
  ...
  {path: 'transaction-book', component: TransactionBookComponent, canActivate:[AuthGuard], data:{roles:['User']}},
